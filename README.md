...
The discount\_type can be either "flat" or "percentage" to specify the type of discount.  
Edge Cases:
...
Product-wise: Check if any product in the cart matches the product\_id in the coupon details. Apply the discount accordingly.  
...
For a product-wise coupon, product\_id should be saved in details.  
For a BxGy coupon, the details field should store a buy\_product array containing product\_id and quantity, along with a get\_product array with product details.
